package de.prolivingplacelab.udpnotruf;
...
public class MainActivity extends AppCompatActivity {
    ...
    static final int UdpClientRequestPORT = 4446;
    ...
    protected void onStart() {
        ...
        tcpServerThread = new TcpServerThread(UdpServerPORT);

        // Telefonnummer einlesen wenn Button geklickt
    ...
    private class TcpServerThread extends Thread{
        ...
        public void run(){
            ...
            try {
                ...
                serverSocket = new ServerSocket(UdpServerPORT);
